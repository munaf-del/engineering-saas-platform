...
const noiseVibrationStandardSources: StandardSourceSeed[] = [
  {
    ...
    groups: [
        ...
        rows: [
          {
            ...
            rowNotes:
              'Monday to Friday 7 am-6 pm; Saturday 8 am-1 pm; no work Sundays or public holidays.',
            sortOrder: 10,
          ...
          },
          {
            ...
            rowNotes:
              'Monday to Friday 9 am-5 pm; Saturday 9 am-1 pm; no blasting Sundays or public holidays.',
            sortOrder: 20,
            workTypes: ['blasting'],
          },
        ],
      },
      {
        ...
        rows: [
          ...
          },
          {
            ...
            sourceClause: 'ICNG Table 2',
            rowNotes:
              'Strong justification and feasible/reasonable mitigation expected for outside-hours works.',
            sortOrder: 30,
            workTypes: broadConstructionWorkTypes,
          },
        ],
      },
      {
        ...
        rows: [
          absoluteNoiseRow(
            'educational-classrooms-internal',
            'Classrooms / educational',
            'educational',
            '45',
            'Internal assessment at centre of occupied room.',
            10,
          ),
          absoluteNoiseRow(
            'hospital-wards-operating-theatres-internal',
          ...
          absoluteNoiseRow(
            ...
            'place_of_worship',
            '45',
            'Internal assessment when in use.',
            30,
          ),
          absoluteNoiseRow(
            'active-recreation-external',
          ...
          absoluteNoiseRow(
            'industrial-external-occupied-point',
            'Industrial premises',
            'industrial',
            '75',
            'External assessment at the most affected occupied point.',
            60,
          ),
          absoluteNoiseRow(
            'office-retail-external-occupied-point',
    ...
    groups: [
      {
        ...
        rows: [
          ...
          },
          {
            ...
            rowNotes:
              'Weekday 0900-1700; Saturday 0900-1300; no blasting Sundays or public holidays.',
            sortOrder: 20,
            workTypes: ['blasting'],
          },
        ],
      },
      {
        ...
        rows: [
          ...
          },
          {
            ...
            sourceClause: 'Draft Construction Noise Guideline residential NMLs',
            rowNotes:
              'High-impact trigger for supplementary mitigation consideration outside standard hours.',
            sortOrder: 40,
            workTypes: broadConstructionWorkTypes,
          },
        ],
  ...
  },
  {
    ...
    instrumentType: 'guidance_only',
    sourceCitation:
      'NSW Department of Environment and Conservation, Assessing vibration: a technical guideline, 2006.',
    notes:
    ...
    groups: [
      {
        ...
        description:
          'Preferred and maximum vibration dose values by receiver type and time period.',
        sortOrder: 10,
        rows: [
          vdvRow(
            'critical-areas-day',
            'Critical areas daytime VDV',
            'critical_area',
            'day',
            '0.10',
            '0.20',
          ...
          vdvRow(
            'critical-areas-night',
            'Critical areas night-time VDV',
            'critical_area',
            'night',
            '0.10',
            '0.20',
          ...
          vdvRow(
            'offices-schools-worship-day',
            'Offices, schools, educational institutions and places of worship daytime VDV',
            'educational',
            'day',
            '0.40',
            '0.80',
          ...
          vdvRow(
            'offices-schools-worship-night',
            'Offices, schools, educational institutions and places of worship night-time VDV',
            'educational',
            'night',
            '0.40',
            '0.80',
  ...
  },
  {
    ...
    instrumentType: 'guidance_only',
    sourceCitation:
      'ANZEC, Technical basis for guidelines to minimise annoyance due to blasting overpressure and ground vibration, 1990.',
    notes:
        ...
        rows: [
          {
            ...
            rowNotes:
              'Standard criterion may be exceeded on up to 5% of blasts over 12 months; absolute maximum applies at any time.',
            sortOrder: 10,
            workTypes: ['blasting'],
          },
        ],
        ...
        rows: [
          {
            ...
            sourceClause: 'ANZEC blasting criteria',
            rowNotes:
              'Blasting should generally only be permitted 9 am-5 pm Monday-Friday and 9 am-1 pm Saturday; not Sundays or public holidays.',
            sortOrder: 10,
            workTypes: ['blasting'],
          },
        ],
    ...
    groups: [
      {
        ...
        locationBasis: 'any',
        description:
          'DIN 4150-3 short-term vibration guideline values by structure type, location and frequency band.',
        sortOrder: 10,
        rows: [
          ...dinRows(
            'commercial-industrial',
            'Commercial / industrial / similar',
            'commercial',
            '20',
            '20',
            '40',
          ...
          ...dinRows(
            'sensitive-heritage',
            'Particularly sensitive / heritage / intrinsic value',
            'heritage',
            '3',
            '3',
            '8',
  ...
  },
  {
    ...
    instrumentType: 'guidance_only',
    sourceCitation:
      'BS 7385-2, Evaluation and measurement for vibration in buildings - Guide to damage levels from groundborne vibration.',
    notes:
    ...
    groups: [
      {
        ...
        description:
          'BS 7385-2 guide values represented as queryable transient and continuous PPV rows.',
        sortOrder: 10,
        rows: [
          bsRow(
            'reinforced-framed-transient',
            'Reinforced / framed industrial and heavy commercial - transient',
            'commercial',
            'transient vibration',
            '50',
            undefined,
          ...
          bsRow(
            'reinforced-framed-continuous',
            'Reinforced / framed industrial and heavy commercial - continuous',
            'commercial',
          ...
          bsRow(
            'unreinforced-light-transient-4-15hz',
            'Unreinforced / light framed residential or light commercial - transient 4-15 Hz',
            'residential',
            'transient vibration',
            undefined,
            '15',
          ...
          bsRow(
            'unreinforced-light-transient-15-40hz',
            'Unreinforced / light framed residential or light commercial - transient 15-40 Hz and above',
            'residential',
            'transient vibration',
            undefined,
            '20',
          ...
          bsRow(
            'unreinforced-light-continuous-4-15hz',
            'Unreinforced / light framed residential or light commercial - continuous 4-15 Hz',
            'residential',
            'continuous vibration',
            undefined,
            '7.5',
          ...
          bsRow(
            'unreinforced-light-continuous-15-40hz',
            'Unreinforced / light framed residential or light commercial - continuous 15-40 Hz and above',
            'residential',
            'continuous vibration',
            undefined,
            '10',
