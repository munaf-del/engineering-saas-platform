...
import { DraftingScheduleSheetPreviewPage } from '@/features/drafting/schedules/drafting-schedule-sheet-preview';
...
export default function ProjectDraftingSchedulePreviewPage({
  ...
  return (
    <DraftingScheduleSheetPreviewPage
      ...
      initialMode={issueId ? 'issue' : mode === 'pack' ? 'pack' : sheetId ? 'sheet' : 'legacy'}
