...
import {
  ...
  type DraftingDrawingSheetPreviewMode,
} from '@/features/drafting/sheets/drafting-drawing-sheet-preview';
import { useProject } from '@/hooks/use-projects';
import { ApiError } from '@/lib/api-client';

export default function ProjectDraftingDrawingSheetPreviewPage({
  params,
  searchParams,
}: {
