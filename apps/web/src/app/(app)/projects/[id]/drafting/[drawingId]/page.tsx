...
import { DraftingEditor } from '@/features/drafting/drafting-editor';
import { useProject } from '@/hooks/use-projects';
import { ApiError } from '@/lib/api-client';

export default function ProjectDraftingEditorPage({
  params,
}: {
  ...
  return <DraftingEditor drawingId={drawingId} project={project} projectId={projectId} />;
}
