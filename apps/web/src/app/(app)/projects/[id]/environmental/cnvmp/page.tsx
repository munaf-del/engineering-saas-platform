...
import { CnvmpWorkspace } from '@/features/cnvmp/cnvmp-workspace';
import { useProject } from '@/hooks/use-projects';
import { ApiError } from '@/lib/api-client';

export default function ProjectEnvironmentalCnvmpPage({
  params,
}: {
  ...
  return <CnvmpWorkspace projectId={projectId} project={project} />;
}
