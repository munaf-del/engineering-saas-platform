...
import { WasteClassificationReportsPanel } from '@/features/environmental/waste-classification-reports-panel';
import { extractProjectSpecifics } from '@/features/projects/project-specifics-adapter';
import { useProject } from '@/hooks/use-projects';
import { ApiError } from '@/lib/api-client';

export default function ProjectWasteClassificationReportsPage({
  params,
}: {
  ...
  return (
    <>
      ...
      <PageHeader
        title="Waste Classification Reports"
        description={`${project.code} · NSW EPA step-based waste classification deliverables`}
        badges={
          <>
      ...
      <WasteClassificationReportsPanel projectId={projectId} />
    </>
  );
}
