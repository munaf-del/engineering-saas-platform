...
import { EnvironmentalMonitoringWorkspace } from '@/features/environmental/environmental-monitoring-workspace';
import { useProject } from '@/hooks/use-projects';
import { ApiError } from '@/lib/api-client';

export default function ProjectEnvironmentalMonitoringDetailPage({
  params,
}: {
