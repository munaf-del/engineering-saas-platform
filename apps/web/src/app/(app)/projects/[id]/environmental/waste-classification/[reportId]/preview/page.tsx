...
import { WasteClassificationPreview } from '@/features/environmental/waste-classification-preview';
import { useProject } from '@/hooks/use-projects';
import { ApiError } from '@/lib/api-client';

export default function ProjectWasteClassificationPreviewPage({
  params,
}: {
