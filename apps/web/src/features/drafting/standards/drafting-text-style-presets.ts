...
export const DRAFTING_TEXT_HEIGHT_PRESETS_MM = [2.5, 3.5, 5, 7, 10, 14, 20] as const;

export const DRAFTING_EXTENDED_TEXT_HEIGHT_PRESETS_MM = DRAFTING_TEXT_HEIGHT_PRESETS_MM;
