...
export const MultiPilePileTypeDefinitionSchema = z.object({
  ...
  socketLengthM: z.number().min(0).nullable().optional(),
  socketLengthMm: z.number().min(0).nullable().optional(),
  foundingStratum: z.string().optional(),
  foundingNote: z.string().optional(),
  designCompressionKn: z.number().min(0).nullable().optional(),
  designTensionKn: z.number().min(0).nullable().optional(),
  designLateralKn: z.number().min(0).nullable().optional(),
